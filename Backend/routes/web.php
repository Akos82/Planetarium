...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/elfelejtett-jelszo',           [AuthController::class, 'showForgotPassword'])->name('password.request');
    Route::post('/elfelejtett-jelszo',          [AuthController::class, 'sendResetLink'])->name('password.email');
    Route::get('/jelszo-visszaallitas/{token}', [AuthController::class, 'showResetPassword'])->name('password.reset');
    Route::post('/jelszo-visszaallitas',        [AuthController::class, 'resetPassword'])->name('password.update');
});
